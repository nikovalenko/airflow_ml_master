...
config["preprocess_data"] = {
    ...
    "s3_out_bucket": "ml-ops-bucket",  # replace
    "s3_out_prefix": "preprocess/",
    "delimiter": "\t"
}

config["prepare_data"] = {
    "s3_in_bucket": "ml-ops-bucket",  # replace
...
config["train_model"] = {
    ...
    "estimator_config": {
        ...
        "train_max_run": 3600,
        "output_path": "s3://ml-ops-bucket/train/",  # replace
    ...
    "inputs": {
        "train": "s3://ml-ops-bucket/prepare/train/train.protobuf",  # replace
    }
}
...
config["tune_model"] = {
    ...
    "inputs": {
        "train": "s3://ml-ops-bucket/prepare/train/train.protobuf",  # replace
        "test": "s3://ml-ops-bucket/prepare/validate/validate.protobuf"  # replace
    }
}
...
config["batch_transform"] = {
    "transform_config": {
        ...
        "data": "s3://ml-ops-bucket/prepare/test/",
        "data_type": "S3Prefix",
        "content_type": "application/x-recordio-protobuf",
        "strategy": "MultiRecord",
        "output_path": "s3://ml-ops-bucket/transform/"
    }
}
